...
ТЗ детям:
1. Очки муравья за достижения.
2. Цвета базы по умолчанию (у Матвея есть)
3. Расширить функцию newLabel на случаи наложения разных и одинаковых меток с пределом. (у Никиты есть)
4. Корм по кликам в одну точку (у Максима есть)
5. $ Отдельная функция для округления.
или $ Базы по кругу.
