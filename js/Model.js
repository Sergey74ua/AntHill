...
ТЗ детям:
- Во всем коде подключить функцию Антиколизия (изменить Items у детей).
- Расширить функцию newLabel на случаи наложения разных и одинаковых меток с пределом.
- Выделить в отдельную функцию создание корма.
- Базы по кругу.
- Корм по центру.
- повсеместно внедрить size.
- очки муравья за достижения.
- Случайный диапазон таймера.
- Цвета базы по умолчанию (у Матвея уже сделано).
- Перенести функцию vision в Ant.
- Проверку на пустоту корма вынести отдельно.
- Убрать goal и добавить listTarget, который заполнять в vision.
- Действие Атака.
*/